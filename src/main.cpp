...
uint256 hashGenesisBlock("0x82a39480007522a02664b59ddfbfca73bb9cf5d2d9b2dceb8363bcc4f0352dd9");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // ObamaCoin: 840k blocks 

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 8 * 60 * 60; // ObamaCoin: 8 hours target diff
static const int64 nTargetSpacing = 600; // ObamaCoin: 10 minutes to generate a new block - update 14-04-2014: CHANGE BLOCK TIME BUG
...
{
    // ObamaCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfa8ea9b4b18ee346489152114bc65d6d1446749077e9dcff92ff9eb384c28239");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0x3283e1290a9b8751ecccc4da4a5345b5550c3010b53f30890d2fb73282e9f21e"));
		block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // ObamaCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ObamaMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ObamaMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running ObamaMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
